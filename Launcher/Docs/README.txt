...
4. Sign in via the Profile tab (EA account + Cypress username)
5. Join a server from the Server Browser, or host your own in the Host tab

To host, you have three options:
- EU Relay (easiest, no port forwarding needed - just enable it in Host > Network)
